    ...
    <section className="hero" id="hero" aria-labelledby="heroHeadline">
      ...
      <div className="hero__content">
        ...
        <p className="hero__meta reveal-up">
          ...
          <span className="hero__ticket-price" aria-label="Costo del boleto: $100 pesos mexicanos">
            🎟️ Boleto <strong>$100 MXN</strong>
            <span className="hero__ticket-perks">· Comida &amp; Catering · Acceso total · Rifa de premios</span>
          </span>
        </p>
        <div className="hero__ctas reveal-up">
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSeKawtS5thfRsITdo1GixjfXJAVAwKvEn2UldyQeDGq9feR-A/viewform" target="_blank" rel="noopener noreferrer"
