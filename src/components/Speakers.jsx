...
const speakersData = [
  ...
  // 7 — Incude Bloque 2
  { initials: "CV", name: "Cecilia de la Paz Villarreal Cavazos", company: "IT Management & Delivery", role: "Deputy Director · IT Manager · Scrum Master · Technical Lead", bio: "Deputy Director of Development con experiencia como IT Manager, Scrum Master y Delivery Manager. Liderazgo femenino y gestión ágil en proyectos de tecnología.", gradient: "linear-gradient(135deg,#db2777,#9333ea)", trackClass: "track-c", trackName: "Incude — Bloque 2", talkIcon: "⚖️", talkName: "Inclusión & Ética Track" },
  // 8 — Cloud Bloque 3
  { initials: "SR", name: "Santiago Reyes Chávez", company: "SAP", role: "GCID AIOps Engineer (SRE) · MS Applied AI ITESM", bio: "AIOps Engineer en SAP con maestría en Inteligencia Artificial Aplicada del ITESM. Especialista en SRE, innovación y analítica avanzada de datos con enfoque en energías renovables.", gradient: "linear-gradient(135deg,#008FD3,#00C4CC)", trackClass: "track-a", trackName: "Cloud — Bloque 3", talkIcon: "🤖", talkName: "IA & Cloud Track" },
  // 9 — Cyber Bloque 3
